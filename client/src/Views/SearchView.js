...
const SearchView = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://localhost:5000/api/google/search-web/${searchValue}/1`)
      .then((response) => {
    ...
    axios
      .get(`https://localhost:5000/api/google/search-images/${searchValue}/1`)
      .then((response) => {
  ...
  const handleSearch = (i) => {
    axios
      .get(`https://localhost:5000/api/google/search-web/${searchValue}/${i}`)
      .then((response) => {
        setResults(response.data.results);
      })
      .catch((error) => {
